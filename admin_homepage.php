...
<head>
  ...
  <link rel="stylesheet" type="text/css"  href="vendor/css/bootstrap-select.min.css">
    ...
    <body>
      <a href="admin_view_score">View Score</a></br>
      <a href="admin_changepass">Change Password</a></br>
      <a href="admin_register_voter.php">Add Voters</a></br>
      <a href="admin_register_candidate.php">Add candidate</a>
